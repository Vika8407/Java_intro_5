...
public class Exercise02_GetNumberDivitedBy5 {
    public static void main(String[] args) {
        ...
        do {
            System.out.println(" Please enter aumber n");
             num2 = input.nextInt() ;
            if (num2 % 5 != 0) System.out.println(" ");
      ...
      for(;;){
          ...
          if(num3 % 5 != 0 ) System.out.println("This number is divided by 5 ");
          else break;
      }
