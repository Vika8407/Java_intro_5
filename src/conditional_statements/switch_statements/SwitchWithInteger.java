...
public class SwitchWithInteger {
    public static void main(String[] args) {
        ...
        if(day == 1) System.out.println("Monday and Blue");
                          ...
                          // We ude switch when we have few cases
        System.out.println("\n-------switch way-------\n"); // switch statements can NEVER be used with boolean
        switch (day){                                       // we can use with int, byte,short,String,Enum( absolute numbers)
            case 1:
